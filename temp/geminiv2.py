...
def draw_sweep_line(angle):
    ...
    # Drawing slices instead of lines guarantees a solid, impactful trail presence.
    trail_width_deg = 30
    for offset in range(trail_width_deg, 0, -1):
        ...
        alpha = int(140 * (1 - offset / trail_width_deg)) # Adjusted transparency gradient
        ...
        if fade_d1 is not None and 2 < fade_d1 < MAX_DISTANCE:
            ...
            ox2, oy2 = polar_to_xy(a2, fade_d2 if fade_d2 else fade_d1)
    ...
    if dist_at_angle is not None and 2 < dist_at_angle < MAX_DISTANCE:
        ...
        # Red/Orange Threat Indicator line (3px thick)
